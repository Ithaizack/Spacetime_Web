...
export function FormNewMemory(){
  ...
  async function handleCreateMemory(event: FormEvent<HTMLFormElement>){
    ...
    await api.post('/memories',{
      ...
      headers:{
        Authorization: `Bearer ${Cookie.get('Tokem')}`
      }
    })
  ...
  return (
    ...
    <button type="submit" className="mt-3 inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600" >Salvar</button>
